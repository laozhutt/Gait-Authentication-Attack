...
RESULTS_DIR = 'pcc_data_splitted/owner_ren_data_splitted'
...
class myAuth(Authentication):
	...
	def oneSampleTest(self, attackSample):
		...
		if auth_result:
			with open(os.path.join(LOG_DIR, 'log_owner'), 'a') as f:
	...
	def authFunc(self, attackSample):
		...
		for cycle_train_name in cycle_train_list:
			train_values = []
			train_filepath = os.path.join(ROOT, MIMICRY_DIR, self.victim, cycle_train_name)
